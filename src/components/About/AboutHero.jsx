...
//           >
//             <HeartPulse size={26} className="text-sky-200" />
//           </motion.div>
...
//             A pharmaceutical merchant exporter and domestic supplier,
//             connecting quality-assured medicines to markets across India and
//             beyond.
//           </p>
  ...
  return (
    <section className="relative py-14 sm:py-20 overflow-hidden">
      ...
      >
        <img
          src={aboutBg}
          alt="About Varelia Lifesciences"
